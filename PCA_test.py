...
for FrameRange_ind in range(len(offset_list)):
    ...
    for CompNumber in CompNumb:
        ...
        plt.savefig("clusters/" + str(offset) + "to" + str(upto) + "_CompNumber" + str(CompNumber) + ".png", bbox_inches='tight')
        ...
        plt.savefig("fn_fp/" + str(offset) + "to" + str(upto) + "_CompNumber" + str(CompNumber) + ".png", bbox_inches='tight')
        ...
        plt.title('F1 score')
        plt.ylabel('Number of units')
        plt.savefig("f1/" + str(offset) + "to" + str(upto) + "_CompNumber" + str(CompNumber) + ".png", bbox_inches='tight')
